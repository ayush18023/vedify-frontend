...
const HomeCatagoryCards = () => {
  return (
    <div>
      <Flex h="12rem" justify="space-around" marginBottom="30px">
        <Box
          ...
          _hover={{
            boxShadow:
              "rgba(14, 30, 37, 0.02) 0px 2px 4px 0px, rgba(14, 30, 37, 0.1) 0px 2px 26px 0px",
            transition: "all 0.4s ease",
          }}
        >
          ...
          <Flex align="center" h="40%" px="40px" bg="white">
            <Link to="/Medicines">
              <Button
                h="45px"
                w="135px"
            ...
            <Box>
              ...
              >
                ...
                <Text
                  ...
                  borderRadius="lg"
                  className="newTag"
                  bg="rgb(71, 129, 236) linear-gradient(111.54deg, rgb(71, 129, 236) 27.04%, rgba(255, 255, 255, 0.314) 51.42%, rgb(71, 129, 236) 73.38%) repeat scroll 0% 0% / auto padding-box border-box"
                >
                  NEW
                </Text>
              </Flex>
